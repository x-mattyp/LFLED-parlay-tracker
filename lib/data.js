...
export async function getMembers() {
  return check(
    await db().from('members').select('id, name, is_admin, external_team_id, team_name, team_abbr, team_logo, team_owner, logo_url, logo_source, logo_error, pin_hash').order('name')
